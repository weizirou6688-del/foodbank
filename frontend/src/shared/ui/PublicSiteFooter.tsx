        ...
        <div className="max-w-[1200px] mx-auto px-6 py-16">
          <div className="grid md:grid-cols-12 gap-12 mb-12">
            <div className="md:col-span-6">
              ...
              <div className="mb-6">
                <div className="text-[13px] font-semibold uppercase tracking-wide mb-2 text-[#ffffff]">
                  Contact Office
                </div>
              ...
              <div className="flex items-center gap-3">
                <a
                  href="#twitter"
                  className="w-9 h-9 bg-[#21262D] hover:bg-[#FFB800] rounded-[4px] flex items-center justify-center transition-all group"
                  aria-label="Twitter"
                >
            ...
            {footerSections.map((section) => (
              <div key={section.title} className="md:col-span-2">
                <h4 className="text-[13px] font-semibold mb-4 uppercase tracking-wide text-[#8B949E]">
                  {section.title}
                </h4>
                  ...
                  {section.links.map((link) => (
                    <li key={link.path}>
                      <a
                        ...
                        className="text-[15px] text-white hover:text-[#FFB800] transition-colors"
                      >
                        {link.label}
                      </a>
                    </li>
