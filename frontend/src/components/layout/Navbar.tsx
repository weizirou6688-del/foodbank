// Compatibility stub: re-export from new location (widgets/layout/Navbar)
export { default } from '@/widgets/layout/Navbar'

/* Old implementation moved to widgets/layout/Navbar.tsx
