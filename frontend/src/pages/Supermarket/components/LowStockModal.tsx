      ...
      <div className="mx-4 max-h-[80vh] w-full max-w-2xl overflow-hidden rounded-lg bg-white shadow-xl">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    title="Add this inventory item to the form"
                  >
                    <Plus size={18} />
                  </button>
                  <button
        ...
        >
          <p className="text-center text-[13px]" style={{ color: '#6B7280' }}>
            Click + to add a linked inventory item to the form. Dismiss only hides an item on this page and does not change the database.
          </p>
        </div>
      </div>
    </div>
