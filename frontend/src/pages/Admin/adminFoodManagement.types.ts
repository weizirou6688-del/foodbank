...
export interface PackageRow {
  ...
  id: number;
  name: string;
  category: PackageCategoryOption | string;
  threshold: number;
  stock: number;
...
export interface InventoryEditorDraft {
  name: string;
  category: InventoryCategoryOption | string | "";
  unit: string;
  threshold: string;
}
export type ActiveItemEditorTarget = {
  mode: "create" | "edit";
  itemId: number | null;
};
export type ItemEditorTarget = ActiveItemEditorTarget | null;
...
export type ActivePackageEditorTarget = {
  mode: "create" | "edit";
  packageId: number | null;
};
export type PackageEditorTarget = ActivePackageEditorTarget | null;
...
export interface PackageDeleteTarget {
  id: number;
  name: string;
}
